(function($) {
  ...
  ========================================================*/
  $(document).ready(function() {
    // Get the county and city select elements
    const countySelect = document.getElementById('id_county');
    const citySelect = document.getElementById('id_city');

    if (countySelect && citySelect) {
      // Function to update cities when county changes
      function updateCities(countyId) {
        const citySelect = document.getElementById('id_city');
        citySelect.innerHTML = '<option value="">Select City</option>';

        if (countyId) {
            // Update this URL to match the working endpoint
      ...
      // Only add listeners if the county select exists
      if (countySelect) {
